  ...
  module: {
    rules: [
          ...
          /** 'thread-loader' */
          {
            ...
            options: {
              ...
              plugins: [
                ...
                ['@babel/plugin-proposal-private-methods', { loose: true }]['@babel/plugin-proposal-object-rest-spread'],
                ['@babel/plugin-syntax-dynamic-import'],
                ['@babel/plugin-transform-runtime'],
                // ['styled-jsx/babel'],
                ['babel-plugin-import', { libraryName: 'antd', libraryDirectory: 'es', style: true }],
                isPro() ? null : ['react-refresh/babel']
              ].filter(Boolean)
            }
          }
        ]
      ...
      },
      {
        test: /\.svg(\?v=\d+\.\d+\.\d+)?$/,
        exclude: [JoinCwd('node_modules')],
        include: [[JoinCwd('src/Render/assets/svg')]],
        use: [
          {
            loader: 'babel-loader',
            options: {
      ...
      //     // , Core.JoinCwd('src/Render/assets/svg')
      ...
      {
        test: /\.(css)$/,
        include: [JoinCwd('src', 'Render', 'assets', 'css')],
        use: [
          isPro() ? MiniCssExtractPlugin.loader : 'style-loader',
          'css-loader',
          {
